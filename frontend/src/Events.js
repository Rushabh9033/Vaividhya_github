...
export const EVENT_IMAGES = {
  "adrena": ADARENA, // Fixed spelling from adarena
  ...
  "logo-hunt": LOGOHUNT,
  "ludo-king": LUDOKING,
  "mini-musti-for-1-min": MINIMUSTIFOR1MIN, // NEW
  "mystic-mover": MYSTICMOVER,
  "puzzle-hunt": PUZZLEHUNT,
  "quantum-quest-physics": QUANTUMQUEST,
  "real-life-among-us": REALLIFEAMONGUS, // NEW
  "reverse-coding": REVERSEDCODING,
  "robo-football-clash": ROBOFOOTBALL, // Fixed key
  "robo-mind-matrix": ROBOMINDMATRIX, // NEW
  "robo-rush": ROBORUSH,
  "robo-war-pro": ROBOWAR, // Fixed key
  "autonomous-robotics-workshop": AUTONOMOUSROBOTICS,
  "robotics-challenge": ROBOTICSCHALLENGE,
  "spin-mania": SPINMANIA,
  "survivor-drop": SURVIVORDROP, // NEW
  "the-chemical-detective": THECHEMICALDETECTIVE, // NEW
