...
const eventDetailsData = {
  ...
  "bgmi": {
    ...
    poster: BGMIDOMINATION,
    fee: "150",
    about: "Battlegrounds Mobile India tournament.",
    registration: "Fee: 150 per team.",
    rules: ["Fair play.", "No emulators."],
  ...
  "mini-musti-for-1-min": {
    name: "Mini Musti For 1 Min",
    tagline: "1 Minute to Win It",
    poster: MINIMASTI,
    fee: "50",
    about: "Fun one-minute games.",
    registration: "Fee: 50",
    rules: ["1 minute limit."],
    rounds: ["Various Games"],
    venue: "Fun Zone",
    time: "All Day",
    prizes: "Goodies",
    facultyCoordinator: "Coordinator",
